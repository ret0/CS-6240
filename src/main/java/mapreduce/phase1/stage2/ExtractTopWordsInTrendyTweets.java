...
/**
 * Phase 1, Stage 2: Find the most used words per hashtag 
...
public class ExtractTopWordsInTrendyTweets extends Configured implements Tool {
    ...
    public static class Reduce extends MapReduceBase implements
        ...
        public void reduce(Text key,
            ...
            output.collect(key,
                    new Text(StringUtils.join(topNWordCounts.keySet(), ",")));
        }
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        /*
         * conf.set(VARNAME_STOPWORDS_LIST, other_args.get(2)); DistributedCache
